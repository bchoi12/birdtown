...
export namespace StringFactory {
	...
	const buffUsage = new Map<BuffType, string>([
		...
		[BuffType.CRIT, "Increases critical"],
		...
		[BuffType.FIERY, "Fire faster and set your opponents on fire"],
		[BuffType.GLASS_CANNON, "Increase ammo, firing rate, and on-hit damage"],
		[BuffType.HEALER, "Heal your teammates with your bullets"],
		[BuffType.ICY, "Shoot giant bullets that slow down your enemies"],
		[BuffType.JUICED, "Increases weapon mastery - at level 3, your scouter is always charged"],
