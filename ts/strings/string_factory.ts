...
export namespace StringFactory {
	...
	const buffNames = new Map<BuffType, string>([
		...
		[BuffType.TANK, "BORB"],
		[BuffType.VAMPIRE, "Keyboard Warrior"],
	...
	const buffUsage = new Map<BuffType, string>([
		...
		[BuffType.CRIT, "Increases critical effects and poison chance (% max health)"],
		...
		[BuffType.FIERY, "Fire faster and set your opponents on fire (% health)"],
		[BuffType.GLASS_CANNON, "Massively increase offensive capabilities at the cost of your health"],
