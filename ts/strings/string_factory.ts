...
export namespace StringFactory {
	...
	const entityNames = new Map<EntityType, ParamString>([
		...
		[EntityType.GOLDEN_WING, ParamString.of("golden wing").set(ParamType.COLOR, ColorFactory.entityColor(EntityType.GOLDEN_GUN).toString())],
	...
	const entityUsage = new Map<EntityType, ParamString>([
		...
		[EntityType.GOLDEN_WING, ParamString.of("Overwhelm your enemies")],
	...
	const statFns = new Map<StatType, StatFn>([
		...
		[StatType.SCALING, toBoost],
		[StatType.SHIELD, toInt],
		[StatType.SHIELD_STEAL, toBoost],
		[StatType.SPEED_BOOST, toBoost],
		[StatType.SPEED_DEBUFF, toBoost],
		[StatType.SLOW_CHANCE, toBoost],
