...
export namespace LoginNames {
	const birdNames = new Array<[string, ColorType]>(
		...
		["Badtz‑Maru", ColorType.PLAYER_YELLOW],
		...
		["Kiiroitori", ColorType.PLAYER_YELLOW],
